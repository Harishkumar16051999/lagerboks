  ...
  return (
    <>
      ...
      >
        ...
        <NavLink onClick={() => props.showSidebar(false)} to={'/postBooking/Profile'} className='item disablBefore fs-7 py-2' >
        ...
        <NavLink onClick={() => props.showSidebar(false)} to={'/postBooking/myLeases'} className='item disablBefore fs-7 py-2 '>
          <svg className='mr-1' height='15' width='15' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.754 21.751">
        ...
        <NavLink onClick={() => props.showSidebar(false)} to={'/postBooking/myInvoices'} className='item disablBefore fs-7 py-2'>
          <svg className='mr-1' height='15' width='15' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.981 21.707" >
        ...
        <NavLink onClick={() => props.showSidebar(false)} to={'/postBooking/payment'} className='item disablBefore fs-7 py-2'>
          <svg className='mr-1' height='15' width='15' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.004 16.009">
        ...
        <NavLink onClick={() => props.showSidebar(false)} to={'/postBooking/updatePassword'} className='item disablBefore fs-7 py-2'>
          <svg className='mr-1' height='15' width='15' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.646 27.078" >
        ...
        <a onClick={() => SetLogoutModal({ open: true, size: 'mini', dimmer: 'blurring' })} className='item disablBefore fs-7 py-2'>
          <svg className='mr-1' height='15' width='15'
