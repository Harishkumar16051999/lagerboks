...
import MoreInfoAccordion from '../moreinfoaccordion/MoreInfoAccordion'
...
const UnitsCard = () => {
    ...
    return (
        <>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-lg-3 col-md-12 col-sm-12 position-relative'>
                            ...
                            <div className='view-img position-absolute t-1 l-1'>
                                <img onClick={() => SetunitTypeModal({ open: true, size: 'tiny', dimmer: 'blurring' })} className='cursor-pointer' src='/assets/images/units-view.png' alt='Units Container' />
                            </div>
                        </div>
                        <div className='col-lg-9 col-md-12 col-sm-12'>
                            <div className='row align-items-center'>
                                <div className='col-lg-6 col-md-12 col-sm-12'>
                                    <div className='units-card-title-div px-3 py-3 px-md-2 py-md-2'>
                                        <h2 className='fs-5 fw-600 mb-1'>25 m2 Self Storage</h2>
                                        <div className='units-card-desc'>
                                            <div className='d-flex flex-wrap units-amenitiy'>
                                                ...
                                                <div className='d-flex align-items-center'>
                                                    <svg id="Variety_of_sizes" data-name="Variety of sizes" xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16.416 16.415">
                                                        <path id="Path_17562" data-name="Path 17562" d="M0,8.206Q0,5.172,0,2.138A2.049,2.049,0,0,1,1.6.063,2.475,2.475,0,0,1,2.156.007q6.047,0,12.1,0A2.062,2.062,0,0,1,16.415,2.17q0,6.038,0,12.076a2.064,2.064,0,0,1-2.176,2.173q-6.027,0-12.055,0A2.067,2.067,0,0,1,0,14.234Q0,11.22,0,8.206Zm.827.011c0,2,.018,4.005-.009,6.008A1.316,1.316,0,0,0,2.2,15.6q6.008-.029,12.016,0A1.313,1.313,0,0,0,15.6,14.236c-.018-4.019-.007-8.038-.009-12.056A1.228,1.228,0,0,0,14.251.832q-6.048,0-12.1,0a1.675,1.675,0,0,0-.377.032,1.218,1.218,0,0,0-.95,1.265q0,3.044,0,6.088Z" transform="translate(0.001 -0.005)" fill="#1CB0E8" />
                                                        <path id="Path_17563" data-name="Path 17563" d="M47.5,187.3h.235c.66,0,1.321,0,1.982,0,.287,0,.469.161.471.4s-.176.408-.465.408q-1.582,0-3.163,0c-.321,0-.467-.144-.468-.464q0-1.582,0-3.163c0-.291.159-.468.406-.468a.413.413,0,0,1,.408.467c0,.66,0,1.321,0,1.982v.238c.081-.074.134-.119.183-.168l2.293-2.293a1.413,1.413,0,0,1,.162-.149.405.405,0,0,1,.569.561,1.242,1.242,0,0,1-.147.163l-2.293,2.293c-.05.05-.1.1-.175.187Z" transform="translate(-43.626 -174.172)" fill="#1CB0E8" />
                                                        <path id="Path_17564" data-name="Path 17564" d="M186.7,46.928h-1.576c-.207,0-.414,0-.62,0a.41.41,0,0,1-.444-.411.4.4,0,0,1,.451-.4c.34,0,.681,0,1.021,0q1.06,0,2.122,0c.362,0,.5.135.5.49q0,1.561,0,3.122c0,.306-.158.486-.412.483s-.4-.187-.4-.493q0-.981,0-1.962v-.235c-.086.08-.138.127-.187.177l-2.293,2.292a.955.955,0,0,1-.2.168.38.38,0,0,1-.478-.064.389.389,0,0,1-.068-.494,1.042,1.042,0,0,1,.156-.181q1.146-1.147,2.293-2.292a1.349,1.349,0,0,1,.178-.129l-.044-.068Z" transform="translate(-174.206 -43.645)" fill="#1CB0E8" />
                                                    </svg>
                                                    <span className='fs-8'>Variety of sizes</span>
                                                </div>
                                                <div className='d-flex align-items-center'>
                                                    <svg id="Insurance" xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 14.509 18.124">
            ...
            >
                <Modal.Header className='bg-white border-0 text-white text-center fs-6 py-2 fw-400 position-relative'>
                ...
                <Modal.Content className='mh-400 overflow-y-auto'>
                    <div className='text-center'>
                        <img className='w-75 h-75' src='/assets/images/units-modal-img.png' alt='View units' />
                    </div>
                </Modal.Content>
            </Modal>
        </>
