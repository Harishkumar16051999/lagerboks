...
export default class UnitsDetailsAccordion extends Component {
  state = { activeIndex: 0 }
  ...
  render() {
    ...
    return (
      <Accordion>
        ...
        <Accordion.Content className='py-1' active={activeIndex === 0}>
          <div className='row p-2 dashed-bottom'>
            <div className='col-lg-4 col-md-12 col-sm-12'>
              <div className='card-img px-1'>
                <img style={{ height: '6rem', objectFit: 'cover' }} className="w-100" src='/assets/images/spaces-self-storage.png' alt='Spaces Self Storage' />
              </div>
            </div>
            <div className='col-lg-8 col-md-12 col-sm-12'>
              <div className="card-desc px-1 border-radius-10 mt-sm-2 mb-sm-2">
                <h2 className="fs-4 fw-700 mt-1 mb-2">#23A</h2>
                <div className="pb-1 d-flex align-items-center"><img src='/assets/images/selfstorage.svg' alt='Self Storage' /><span className='ml-1'>Unit - <strong className="fw-700">5 X 10</strong> (large)</span></div>
                <div className='d-flex align-items-center'><img src='/assets/images/location-new.svg' alt='Self Storage' /><span className='ml-1'>Warehouse, Crestline</span></div>
              </div>
            </div>
            <div className='d-flex flex-wrap esign-amenitiy mt-2'>
              <div className='d-flex align-items-center my-1 mr-2'>
                ...
                <span className="ml-1 fs-8 fw-500">Fully automated</span>
              </div>
              ...
              <div className='d-flex align-items-center my-1 mr-2'>
                ...
                <span className="ml-1 fs-8 fw-500">Variety of sizes</span>
              </div>
              ...
              <div className='d-flex align-items-center my-1 mr-2'>
                ...
                <span className="ml-1 fs-8 fw-500">Insurance</span>
              </div>
              ...
              <div className='d-flex align-items-center my-1 mr-2'>
                ...
                <span className="ml-1 fs-8 fw-500">CCTV & Security 24/7</span>
              </div>
              ...
              <div className='d-flex align-items-center my-1 mr-2'>
                ...
                <span className="ml-1 fs-8 fw-500">On-site assistance</span>
              </div>
            </div>
          </div>
          <div className='p-2 dashed-bottom text-left'>
            <h4 className='text-primary mb-1'>Personal Details</h4>
            <p className='text-dark fs-7'>Peter John</p>
            <p className='text-dark fs-7'>peterjohn@gmail.com</p>
            <p className='text-dark fs-7'>(987) 654 3210</p>
          </div>
          <div className='p-2'>
            <h4 className='text-primary mb-1'>Facility Address</h4>
            <p className='text-dark fs-7'>Level 4, 1230 Nepean Highway, Cheltenham, Victoria 3192</p>
          </div>
        </Accordion.Content>
      </Accordion>
    )
