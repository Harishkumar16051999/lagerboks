                ...
                <div className='row'>
                                ...
                                <div className='p-3 px-sm-1'>
                                    ...
                                    <div className='pt-1'>
                                            ...
                                            <div className='d-flex justify-content-between flex-wrap bg-primary-light p-1 border-success-dark-1 border-radius-5'>
                                                ...
                                                <button className="ui button text-success-dark bg-white border-success-dark-1 fs-7 fw-400 text-dark px-2 px-sm-1 mr-2 mt-md-1">View Document</button>
                                            </div>
                                            <div className='pt-4 d-flex justify-content-center flex-wrap'>
                                                <button className="ui button bg-success-dark d-flex align-items-center border-radius-5 fs-6 fw-100 text-white px-5 px-md-2 mb-sm-1"><img src='/assets/images/executed-payment.svg' alt='Pay Now' /><span className='ml-1 fs-6 fw-400'>Pay Now</span></button>
                                            </div>
                                        </div>
                                </div>
                            </div>
                    ...
                    <div className='col-lg-4 col-md-4 col-sm-12'>
                        <div className='mx-2 my-3 mx-sm-0'>
                            <div className='card-border mb-3 bg-white border-radius-10'>
                            <UnitsDetailsAccordion />
                            </div>
                            <div className='bg-white card-boxShadow px-0 py-2 border-radius-10 border-top-success-4'>
