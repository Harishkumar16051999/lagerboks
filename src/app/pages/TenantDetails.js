    ...
    return (
        <div className='tenantDetails-wrapper'>
            <div className='ui container fluid'>
                ...
                {!alreadyUser && <div className='row reverse-sm'>
                    <div className='col-lg-8 col-md-8 col-sm-12 reverse-sm'>
                        <div className='bg-white tenantform-div card-boxshadow py-4 px-3 mx-sm-2'>
                            <div className='card-border border-radius-5 p-3 p-sm-2 mb-4'>
                             ...
                             <div className='tenantDetails-form-wrapper'>
                                <div className='mb-3'>
                    ...
                    <div className='col-lg-4 col-md-4 col-sm-12 accordTenant'>
                        <TenantDetailsAccordion discountModal={() => SetApplyDiscountModal({ open: true, dimmer: 'blurring' })} />
                    </div>
                </div>}
                {alreadyUser && <div className='my-5 py-2 bg-white w-50 mx-auto w-sm-100 card-boxShadow border-radius-10'>
                    <h2 className='py-1 text-primary text-center fw-500 fs-6'>SIGN-IN TO YOUR ACCOUNT</h2>
                    <div className='ui form py-2 px-4 px-sm-2'>
                        <div className='field mb-3'>
                            <label className='fw-400 mb-2'>First Name<i className='error'>*</i></label>
                        ...
                        <div className='field mb-3'>
                            <label className='fw-400 mb-2'>Password<i className='error'>*</i></label>
                            <div className="ui input w-100 position-relative">
