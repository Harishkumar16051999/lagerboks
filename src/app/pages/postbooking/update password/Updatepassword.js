            ...
            <div className="col-lg-12 col-md-12 col-sm-12">
              <h6 className="fs-6 fw-500"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 18.646 27.078">
                <g id="password-svgrepo-com" transform="translate(-31.62)">
                  ...
                  <path id="Path_19672" data-name="Path 19672" d="M95.047,116.309a1,1,0,0,0-1,1v3.828a1,1,0,1,0,2,0v-3.828A1,1,0,0,0,95.047,116.309Z" transform="translate(-54.104 -100.802)" fill="#00aeef" />
                </g>
              </svg>
