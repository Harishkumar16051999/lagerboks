            ...
            {tenantDetails && <div>
              <div className="col-lg-9 col-md-9 col-sm-12">
                <div className="row">
                  <div className="col-lg-4 col-md-4 col-sm-12">
                    <p className="mb-2"> <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 12.426 18.378">
                      <g id="owner" transform="translate(0)">
                        ...
                        <path id="Path_14953" data-name="Path 14953" d="M2077.969-231.344c.167,0,.334-.009.5,0a.622.622,0,0,1,.5.956c-.569.751-.4.909-.334,1.7a4.1,4.1,0,0,0,.069.551,1.054,1.054,0,0,1-.083.643c-.112.277-.21.557-.311.839a.368.368,0,0,1-.371.279.363.363,0,0,1-.371-.276c-.13-.359-.264-.717-.391-1.077a.522.522,0,0,1-.023-.21c.037-.452.074-.905.129-1.356a1.125,1.125,0,0,0-.184-.783c-.055-.085-.115-.167-.168-.254a.647.647,0,0,1,.513-1.011C2077.621-231.355,2077.8-231.344,2077.969-231.344Z" transform="translate(-2071.693 240.273)" fill="#00aeef" />
                      </g>
                    </svg>
                      <span className="text-success-dark ml-1 fw-500">Business User</span></p>
                  </div>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-4">
                    <p className="fs-7 fw-500 text-dark mb-2">Company Name</p>
                  </div>
                  <div className="col-lg-8 col-md-8 col-sm-8">
                    <p className="fs-7 mb-2">xyzstorage</p>
                  </div>

                  <div className="col-lg-4 col-md-4 col-sm-4">
                    <p className="fs-7 fw-500 text-dark">Company Registration#</p>
                  </div>
                  <div className="col-lg-8 col-md-8 col-sm-8">
              ...
              <h6 className="fs-6 fw-500"><svg id="location-svgrepo-com_1_" data-name="location-svgrepo-com (1)" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 21.924 29.667">
                <g id="Group_6994" data-name="Group 6994" transform="translate(0)">
                  <g id="Group_6993" data-name="Group 6993">
                    <path id="Path_19673" data-name="Path 19673" d="M52.065,0A10.975,10.975,0,0,0,41.1,10.962c0,5.852,9.994,17.938,10.419,18.45a.706.706,0,0,0,1.086,0c.426-.512,10.419-12.6,10.419-18.45A10.975,10.975,0,0,0,52.065,0Zm0,27.839c-.886-1.107-2.727-3.464-4.549-6.159-3.271-4.839-5-8.545-5-10.718a9.55,9.55,0,0,1,19.1,0c0,2.173-1.729,5.879-5,10.718C54.792,24.375,52.951,26.733,52.065,27.839Z" transform="translate(-41.103)" fill="#00aeef" />
                    <path id="Path_19674" data-name="Path 19674" d="M154.3,212.791a.706.706,0,0,0-.981.19c-.953,1.411-2.021,2.89-3.174,4.4a.706.706,0,1,0,1.122.859c1.17-1.528,2.254-3.029,3.223-4.463A.706.706,0,0,0,154.3,212.791Z" transform="translate(-139.744 -192.641)" fill="#00aeef" />
                    <path id="Path_19675" data-name="Path 19675" d="M101.792,57.5a5.792,5.792,0,1,0,5.792,5.792A5.8,5.8,0,0,0,101.792,57.5Zm0,10.171a4.379,4.379,0,1,1,4.379-4.379A4.384,4.384,0,0,1,101.792,67.671Z" transform="translate(-90.83 -52.085)" fill="#00aeef" />
                  </g>
                </g>
              </svg>
        ...
        <div className="bg-white card-boxShadow border-radius-15 py-2 mb-2">
          ...
          <div className="py-4 px-3">
            <div className="text-center">
              <img className="w-25 w-sm-100" src="/assets/images/credit-score.png" alt="Credit Score" />
            </div>
          </div>
        </div>
      </div>
